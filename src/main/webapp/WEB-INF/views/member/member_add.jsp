...
<div id="container" class="margin-center" style="width: 500px;">
	<img
		src="<%=request.getContextPath()%>/WEB-INF/resources/img/joinimg.jpg"
		alt="" />
	<form id="join_form">
		<fieldset>
			...
			<input id="password" name="password" value="1" type="password" placeholder="비밀번호" />
			<br /> 
			<span id="join_name">NAME: </span>
			 <input id="name" name="name" type="text" placeholder="이름" value="이길동" />
			 <br />
			<span id="join_name">PHONE: </span> 
			<input id="phone" name="phone" type="text" placeholder="전화번호" value="010-1234-5896" />
			<br /> 
			<span id="join_birth">BIRTHDAY: </span> 
			<input id="ssn" name="ssn" type="date" placeholder="생년월일" />
			<br /> 
			...
			<br /> <input type="checkbox" name="subject" value="c" />C언어<br />
			<input type="checkbox" name="subject" value="html" />HTML<br /> <input
				type="checkbox" name="subject" value="css" />CSS<br /> <input
				type="checkbox" name="subject" value="javascript" />자바스크립트<br /> <input
				type="checkbox" name="subject" value="sql" />SQL<br /> <input
				type="checkbox" name="subject" value="python" />PHTHON<br /> <input
				id="join_yes_button" type="submit" value="등록" /> <input
