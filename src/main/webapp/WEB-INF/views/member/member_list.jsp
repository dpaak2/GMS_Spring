...
<table id="member_list_tab">
	...
	<nav aria-label="Page navigation" style="width:450px; margin: 0 auto;">
	  ...
	  <c:if test="${prevBlock gt 0 }">
	   <li><a onclick="app.member.list('member','list','1')"><span class="glyphicon glyphicon-step-backward " aria-hidden="true"></span></a></li>
	    <li>
	      <a onclick="app.member.list('member','list','${startPage-1}')" aria-label="Previous">
    ...
    <!-- Next -->
      <c:if test="${nextBlock le theNumberOfPages}">       
         <li><a onclick="app.member.list('member', 'list', '${endPage+1}')" href="#" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>
         <li><a onclick="app.member.list('member', 'list', '${theNumberOfPages}')" href="#">
